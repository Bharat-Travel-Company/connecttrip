...
const Footer = () => {
  return (
    <footer className="w-full bg-bg flex flex-col items-center justify-center gap-5">
      ...
      <strong className="mx-auto text-text">
      ...
      <strong className="mx-auto text-text mb-5">
